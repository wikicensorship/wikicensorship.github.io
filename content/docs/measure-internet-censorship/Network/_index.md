...
در انتها، در پاسخ سرور (27)، میزان loss و StDev نرمال است و مشکلی وجود ندارد. 
...
در نتیجه مشخص نیست که در hop های بعد از چهارم، packet ما از چه مسیری رفته و از چه مسیری بازگشته است!
