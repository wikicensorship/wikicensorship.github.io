...
در این تست احتمال می رود که ممکن است صفحه ی مربوط به سانسور به جای صفحه ی اصلی دریافت شده است. 
...
حساسیت به Request URI یا همان ادامه ی آدرس بعد از Hostname. 
(در این تست فقط / هست.)
...
در این حالت، از DNS مسدود شده است.
...
که ممکن است به دلیل وارد سیاهچاله شدن ارتباط باشد و یا ارسال packet های RST. 
...
مقدار resolver_ip برابر IP سرور ای است که کاربر احتمالا در این تست از آن استفاده کرده است. 
